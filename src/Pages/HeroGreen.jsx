...
import { DownloadIcon, MessageCircleHeartIcon } from "lucide-react";
    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="max-w-4xl relative z-10 font-display  text-center">
        ...
        <h1 className=" text-3xl sm:text-5xl md:text-7xl font-bold mt-6 leading-tight ">
          <span className=" bg-gradient-to-r from-white to-green-500 bg-clip-text text-transparent leading-[1.2] ">
            Bridging Tradition ,
          </span>
